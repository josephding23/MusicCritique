...
from util.toolkits.data_convert import generate_midi_segment_from_tensor, generate_data_from_midi, \
...
class CycleGAN(object):
    ...
    def continue_from_latest_checkpoint(self):
        ...
        check_path = 'D:/SteelyGAN/checkpoints/'
