...
class Generator(nn.Module):
    def __init__(self):
        ...
        self.paragraph_cnet1 = nn.Sequential(nn.ReflectionPad2d((3, 3, 3, 3)),
    ...
    def forward(self, tensor_in):
        ...
        x1 = 0.2 * self.bar_cnet(x1) + 0.8 * x1
        x2 = 0.2 * self.bar_cnet(x2) + 0.8 * x2
        x3 = 0.2 * self.bar_cnet(x3) + 0.8 * x3
        x4 = 0.2 * self.bar_cnet(x4) + 0.8 * x4
